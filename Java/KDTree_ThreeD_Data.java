...
public class KDTree_ThreeD_Data
{
    public static void main(String args[]) throws IOException
    {
        ...
        /*
         * System.out.println("Enter the first 5 data set : <x> <y>"); for (int
         * i = 0; i < numpoints; i++) { x[0] = sc.nextDouble(); x[1] =
         * sc.nextDouble(); kdt.add(x); }
         */
